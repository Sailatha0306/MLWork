...
##
##output_movie = cv2.VideoWriter('D:\\Others\\Machine Learning A-Z Template Folder\\12-FaceRecognition\\Video_data\\myTestVideo\\output.avi', fourcc, 29.97, (1920,1080))

image_filenames = glob.glob('D:\\Others\\Machine Learning A-Z Template Folder\\12-FaceRecognition\\Video_data\\myTestVideo\\images' + '\\*.jpg', recursive=True)
...
for path_to_image in paths_to_images:
    ...
    if len(face_encodings_in_image) == 1:
        ...
        matched_name = path_to_image.split('\\')[5][:-4]
        print(matched_name)
